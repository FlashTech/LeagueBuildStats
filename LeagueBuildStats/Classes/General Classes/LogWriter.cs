...
namespace LeagueBuildStats.Classes
{
	...
	{
		private static string file = string.Format(@"{0}\Data\Logs\", PublicStaticVariables.thisAppDataDir);

		private static LogWriter instance;
		private static Queue<Log> logQueue;
		private static string logDir = file;
		private static string logFile = "Log.txt";
		private static int maxLogAge = int.Parse("600");
